...
#ifndef MCA_COLL_ADAPT_CUDA_EXPORT_H
#define MCA_COLL_ADAPT_CUDA_EXPORT_H
...
typedef struct mca_coll_adapt_cuda_module_t mca_coll_adapt_cuda_module_t;
 ...
 * values). 
 */
typedef struct mca_coll_adapt_cuda_component_t {
    /** Base coll component */
    mca_coll_base_component_2_0_0_t super;

    /** MCA parameter: Priority of this component */
    int adapt_cuda_priority;
    ...
    int coll_adapt_cuda_use_nccl;
} mca_coll_adapt_cuda_component_t;
 ...
 */
typedef struct mca_coll_adapt_cuda_comm_t {
    /* Meta data that we get back from the common mmap allocation
       function */
    mca_coll_adapt_cuda_module_t *adapt_bootstrap_meta;
...
} mca_coll_adapt_cuda_comm_t;

/** Coll sm module */
struct mca_coll_adapt_cuda_module_t {
    /** Base module */
	...
	mca_coll_adapt_cuda_comm_t *adapt_comm_data;
...
OBJ_CLASS_DECLARATION(mca_coll_adapt_cuda_module_t);

/**
 * Global component instance
 */
OMPI_MODULE_DECLSPEC extern mca_coll_adapt_cuda_component_t mca_coll_adapt_cuda_component;
...
#endif /* MCA_COLL_ADAPT_CUDA_EXPORT_H */
