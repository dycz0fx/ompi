...
static int shared_register(void)
{
    mca_base_component_t *c = &mca_coll_shared_component.super.collm_version;
    ...
    (void) mca_base_component_var_register(c, "priority", "Priority of the shared coll component",
